...
MINIBATCHES = np.arange(
    ...
    int(os.environ.get("TRAIN_SIZE")),
    int(os.environ.get("TRAIN_SIZE")) /
    (int(os.environ.get("TRAIN_SIZE")) / 10),
)
...
N_EDGE_ELEMENTS, ELEMENT_EDGE_MIN, ELEMENT_EDGE_MAX = 0, 0.8, 0.9

ELEMENT_PLANE_MIN, ELEMENT_PLANE_MAX, N_PLANE_ELEMENTS = 0, 0.6, 0.85

ELEMENT_VOLUME_MIN, ELEMENT_VOLUME_MAX, N_VOLUME_ELEMENTS = 7, 0.3, 0.45
