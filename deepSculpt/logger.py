...
def begin_section(
    message, symbol=TreeSymbols.ACTION, is_last=False, status_color=Colors.CYAN
):
    """
...
def end_section(
    message=None, symbol=TreeSymbols.SUCCESS, is_last=True, status_color=Colors.GREEN
):
    """
